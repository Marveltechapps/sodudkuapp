...
//
//     final latLonLocationResponse = latLonLocationResponseFromJson(jsonString);

import 'dart:convert';

LatLonLocationResponse latLonLocationResponseFromJson(String str) => LatLonLocationResponse.fromJson(json.decode(str));

String latLonLocationResponseToJson(LatLonLocationResponse data) => json.encode(data.toJson());

class LatLonLocationResponse {
    List<dynamic>? htmlAttributions;
    Result? result;
    String? status;

    LatLonLocationResponse({
        this.htmlAttributions,
        this.result,
        this.status,
    });

    factory LatLonLocationResponse.fromJson(Map<String, dynamic> json) => LatLonLocationResponse(
