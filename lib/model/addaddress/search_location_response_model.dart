...
List<SearchedLocationResponse> searchedLocationResponseFromJson(String str) =>
    List<SearchedLocationResponse>.from(
        json.decode(str).map((x) => SearchedLocationResponse.fromJson(x)));

String searchedLocationResponseToJson(List<SearchedLocationResponse> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class SearchedLocationResponse {
  String? description;
  ...
  factory SearchedLocationResponse.fromJson(Map<String, dynamic> json) =>
      SearchedLocationResponse(
